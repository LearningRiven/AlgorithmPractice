...
public class QuickSortTest {
    ...
    void test1Quick(){
        ...
        QuickSort.sortListQuickSort(unOrderedList,"MedianOf3");
    ...
    @Test
    void testNull(){
        assertThrows(IllegalStateException.class,() -> QuickSort.sortListQuickSort(null,null), "removeLast on empty throws");
    }
